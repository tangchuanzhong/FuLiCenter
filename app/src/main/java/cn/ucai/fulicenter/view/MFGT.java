...
public class MFGT {
    ...
    public  void gotoBoutiqueDetails(){

    }
    public  static void gotoBoutiqueDetails(Context context, BoutiqueBean boutiqueBean){
        Intent intent=new Intent(context, BoutiqueDetailsActivity.class);
    ...
    public static void gotoCategoryDetails(Context context, int catId, String groupName, ArrayList<CategoryChildBean> list){
    ...
    public static void gotoUpDateNick(Activity activity) {
        activity.startActivityForResult(new Intent(activity,UpdateNickActivity.class),
                I.REQUEST_CODE_NICK);
    }
